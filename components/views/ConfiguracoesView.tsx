            ...
            <div className="space-y-6 text-xs">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  ...
                  <p className="text-slate-500">
                    Gerencie a integração via <strong className="text-emerald-700 font-semibold font-mono">Evolution API</strong> e outros canais omnichannel.
                  </p>
                </div>
              </div>

              {/* Conexão real com WhatsApp — via Evolution API. */}
